    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    {!! Form::model($teamMember, ['route'=> ['control-panel.team-members.update', $teamMember->id], 'method'=>'patch', 'files'=>'true']) !!}
                    ...
                    <div class="form-group">
                        <div class="btn-group">
                            ...
                            <a class="btn btn-warning" href="{!! route('control-panel.team-members.index') !!}">Cancel</a>
                        </div>
                    </div>
                    {!! Form::close() !!}
                </div>
